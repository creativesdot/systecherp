...
export default class SalesInvoiceEdit extends Component {
          ...
          <Content>
            ...
            <View style={styles.butView}>
              {visibility ?
                ...
                : null}
              <Button dark style={styles.butStyle} onPress={() => { this.props.navigation.navigate('ItemDetails', { id: details.transno, type: "Sales Quotation" }) }}><Text> Item Details </Text></Button>
            </View>
          </Content>
        </Container>
        <Modal
    ...
    fetch("http://106.51.49.166:8090/MMS/rest/api/latest/android/salesquotation_approval", {
      ...
      .then(responseText => {
        ...
        if (a === '1') {
          ...
          this.props.navigation.state.params.SalesInvoice.onRefresh();
