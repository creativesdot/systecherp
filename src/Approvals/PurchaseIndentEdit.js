...
export default class PurchaseIndentEdit extends Component {
          ...
          <Content>
            <Form>
              ...
              <Item stackedLabel last>
                ...
                <Input disabled>{details.purchasetype}</Input>
              </Item>
              <Item stackedLabel last>
                <Label>Prepared_By</Label>
                <Input disabled>{details.prepare}</Input>
              </Item>
              {visibility ?
                <Form>
                  <Item stackedLabel last>
            ...
            <View style={styles.butView}>
              {visibility ?
                ...
                : null}
              <Button dark style={styles.butStyle} onPress={() => { this.props.navigation.navigate('ItemDetails', { id: details.transno, type: "PO" }) }}><Text> Item Details </Text></Button>
            </View>
          </Content>
        </Container>
        <Modal
    ...
    fetch("http://106.51.49.166:8090/MMS/rest/api/latest/android/purchaseindent_approval", {
      ...
      .then(responseText => {
        ...
        if (a === '1') {
          ...
          this.props.navigation.state.params.PurchaseIndent.onRefresh();
