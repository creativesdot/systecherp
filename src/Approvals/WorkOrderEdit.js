          ...
          <Content>
            <Form>
              ...
              <Item stackedLabel last>
                ...
                <Input disabled>{details.category}</Input>
              </Item>
              <Item stackedLabel last>
                <Label>Delivery Address</Label>
                <Input disabled multiline={true}>{details.address}</Input>
              </Item>
              <Item stackedLabel last>
                <Label>Value</Label>
            ...
            <View style={styles.butView}>
              {visibility ?
                ...
                : null}
              <Button dark style={styles.butStyle} onPress={() => { this.props.navigation.navigate('ItemDetails', { id: details.transno, type: "Work Order" }) }}><Text> Item Details </Text></Button>
            </View>
          </Content>
        </Container>
        <Modal
    ...
    fetch("http://106.51.49.166:8090/MMS/rest/api/latest/android/workorder_approval", {
      ...
      .then(responseText => {
        ...
        if (a === '1') {
          ...
          this.props.navigation.state.params.WorkOrder.onRefresh();
